  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-2xl font-bold text-black mb-2">Search Results</h1>
        <p className="text-black mb-8">{q ? `Showing results for "${q}"` : 'Enter a search term'}</p>
        {products.length === 0 ? (
          <div className="text-center py-20"><p className="text-black">No products found.</p></div>
        ) : (
